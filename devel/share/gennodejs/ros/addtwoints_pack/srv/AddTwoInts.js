...
// (in-package addtwoints_pack.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'addtwoints_pack/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'addtwoints_pack/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'addtwoints_pack/AddTwoInts'; }
};
